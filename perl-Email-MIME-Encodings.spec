...
%prep
%setup -q -n Email-MIME-Encodings-1.317
cd %{_builddir}/Email-MIME-Encodings-1.317
...
cp %{_builddir}/Email-MIME-Encodings-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Email-MIME-Encodings/cd5c0b984ad0197337ac06ef67d675185eb23ed4 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Email-MIME-Encodings/cd5c0b984ad0197337ac06ef67d675185eb23ed4
